...
public class Produto {
	...
	@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
	// Cache de relacionamentos, só armazena os id's
...
/*	Lembrando que para guardar a versão, podemos usar uma variável numérica ou um timestamp, 
	que significa que o atributo poderia ser do tipo java.util.Date ou java.util.Calendar. Por exemplo:
